...
const Home = () => {
  ...
  const toggleTourModal = () => setIsTourModalOpen(!isTourModalOpen);
  ...
  return (
    <>
      ...
      <section>
        <Container>
          <Row>
            ...
            <ServiceList
              handleTourGuideClick={() => setIsTourModalOpen(true)}
            />
          </Row>
        </Container>
      </section>
        ...
        <Container>
          <Row>
            <Col lg="12">
              ...
              <h2 className="gallery__title" style={{ color: "greenyellow" }}>
      ...
      <TourGuideModal isOpen={isTourModalOpen} toggle={toggleTourModal} />
    </>
  );
};
